...
## Webシステム [5h]
以下のCheckpoint4に回答できる程度に、Webシステムについて学習しておきましょう。ローカルPCとサーバが互いにどう通信しているか、その仕組みを理解してください。

教材はネットでも書籍でも構いません。特にこだわりが無ければ、鶴長鎮一の『Web技術がこれ1冊でしっかりわかる教科書』の第1章～第5章をざっと読んでください。会社の棚に置いてありますので、貸出可能です（自宅には持ち帰らないでくださいね！）。場所が分からなければ、お気軽に他のアルバイト/社員にお尋ねください。
